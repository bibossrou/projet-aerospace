...
tank_shape = rocketpy.CylindricalTank(radius= 0.04, height = 0.1) 
...
MoteurTest.add_tank(tank_oxidizer, position= 1.35)
...
fusee_essai.add_motor(MoteurTest, position= -0.38)
